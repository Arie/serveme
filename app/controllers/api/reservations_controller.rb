...
class Api::ReservationsController < Api::ApplicationController
  ...
  def reservation_params
    params.require(:reservation).permit(:starts_at, :ends_at, :server_id, :rcon, :password, :first_map, :tv_password, :tv_relaypassword, :server_config_id, :auto_end, :enable_plugins)
  end
