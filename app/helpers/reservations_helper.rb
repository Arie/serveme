module ReservationsHelper
  ...
  def reservation_params
    permitted_params = [:id, :password, :tv_password, :tv_relaypassword, :server_config_id, :whitelist_id, :custom_whitelist_id, :first_map, :auto_end, :enable_plugins, :enable_arena_respawn]
