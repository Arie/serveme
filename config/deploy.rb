...
set :linked_files, fetch(:linked_files, []).push('config/master.key', 'config/database.yml', 'config/puma/production.rb', 'config/initializers/locale.rb', 'config/initializers/maps_dir.rb', 'config/initializers/site_url.rb', 'doc/GeoLite2-City.mmdb', 'doc/GeoLite2-ASN.mmdb', 'config/cacert.pem')
