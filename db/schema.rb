...
ActiveRecord::Schema.define(version: 20170519163845) do
  ...
  create_table "paypal_orders", force: :cascade do |t|
    ...
    t.string   "type"
    t.index ["payer_id"], name: "index_paypal_orders_on_payer_id", using: :btree
    t.index ["payment_id"], name: "index_paypal_orders_on_payment_id", using: :btree
    t.index ["product_id"], name: "index_paypal_orders_on_product_id", using: :btree
    t.index ["user_id"], name: "index_paypal_orders_on_user_id", using: :btree
  end
