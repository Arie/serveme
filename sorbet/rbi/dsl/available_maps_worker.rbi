...
# This is an autogenerated file for dynamic methods in `AvailableMapsWorker`.
# Please instead update this file by running `bin/tapioca dsl AvailableMapsWorker`.
