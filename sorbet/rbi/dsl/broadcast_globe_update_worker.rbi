...
# This is an autogenerated file for dynamic methods in `BroadcastGlobeUpdateWorker`.
# Please instead update this file by running `bin/tapioca dsl BroadcastGlobeUpdateWorker`.
