...
# This is an autogenerated file for dynamic methods in `BuildCaddyCloudflareImageWorker`.
# Please instead update this file by running `bin/tapioca dsl BuildCaddyCloudflareImageWorker`.
