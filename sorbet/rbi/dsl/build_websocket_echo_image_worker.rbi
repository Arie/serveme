...
# This is an autogenerated file for dynamic methods in `BuildWebsocketEchoImageWorker`.
# Please instead update this file by running `bin/tapioca dsl BuildWebsocketEchoImageWorker`.
