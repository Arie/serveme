...
# This is an autogenerated file for dynamic methods in `CarrierWave::Uploader::Download`.
# Please instead update this file by running `bin/tapioca dsl CarrierWave::Uploader::Download`.
