...
# This is an autogenerated file for dynamic methods in `DailyProxyReportWorker`.
# Please instead update this file by running `bin/tapioca dsl DailyProxyReportWorker`.
