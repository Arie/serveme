...
# This is an autogenerated file for dynamic methods in `DailyZipfileUploadWorker`.
# Please instead update this file by running `bin/tapioca dsl DailyZipfileUploadWorker`.
