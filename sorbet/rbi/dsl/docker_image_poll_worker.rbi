...
# This is an autogenerated file for dynamic methods in `DockerImagePollWorker`.
# Please instead update this file by running `bin/tapioca dsl DockerImagePollWorker`.
