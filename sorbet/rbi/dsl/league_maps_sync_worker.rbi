...
# This is an autogenerated file for dynamic methods in `LeagueMapsSyncWorker`.
# Please instead update this file by running `bin/tapioca dsl LeagueMapsSyncWorker`.
