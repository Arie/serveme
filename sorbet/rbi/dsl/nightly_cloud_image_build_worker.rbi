...
# This is an autogenerated file for dynamic methods in `NightlyCloudImageBuildWorker`.
# Please instead update this file by running `bin/tapioca dsl NightlyCloudImageBuildWorker`.
