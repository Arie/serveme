...
class PaypalOrder
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def gift_previously_changed?; end
    ...
    sig { returns(T::Boolean) }
    def payer_id_previously_changed?; end
    ...
    sig { returns(T::Boolean) }
    def payment_id_previously_changed?; end
