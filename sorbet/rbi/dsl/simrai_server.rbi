...
# This is an autogenerated file for dynamic methods in `SimraiServer`.
# Please instead update this file by running `bin/tapioca dsl SimraiServer`.
...
class SimraiServer
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::SimraiServer).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::SimraiServer).void)
      ).returns(::SimraiServer)
    end
    ...
    sig { returns(T::Array[::SimraiServer]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::SimraiServer)) }
    def fifth; end

    sig { returns(::SimraiServer) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::SimraiServer)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::SimraiServer) }
    def find_by!(*args); end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::SimraiServer)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::SimraiServer) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::SimraiServer) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::SimraiServer } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::SimraiServer, T::Enumerable[T.any(::SimraiServer, T::Enumerable[::SimraiServer])])
    ...
    sig do
      params(
        records: T.any(::SimraiServer, Integer, String, T::Enumerable[T.any(::SimraiServer, Integer, String, T::Enumerable[::SimraiServer])])
      ).returns(T::Array[::SimraiServer])
    end
    ...
    sig do
      params(
        other_array: T.any(::SimraiServer, T::Enumerable[T.any(::SimraiServer, T::Enumerable[::SimraiServer])])
      ).returns(T::Array[::SimraiServer])
    end
