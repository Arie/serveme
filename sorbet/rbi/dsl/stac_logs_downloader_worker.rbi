...
# This is an autogenerated file for dynamic methods in `StacLogsDownloaderWorker`.
# Please instead update this file by running `bin/tapioca dsl StacLogsDownloaderWorker`.
