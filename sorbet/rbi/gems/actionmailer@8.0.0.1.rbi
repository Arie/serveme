...
class ActionMailer::Base < ::AbstractController::Base
  ...
  # source://actionview/8.0.0.1/lib/action_view/layouts.rb#212
  ...
  class << self
    ...
    # source://actionview/8.0.0.1/lib/action_view/layouts.rb#211
    def _layout?; end
...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/8.0.0.1/lib/abstract_controller/caching/fragments.rb#34
  def combined_fragment_cache_key(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.0.1/lib/abstract_controller/caching.rb#45
