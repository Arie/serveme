...
module ActionText::RichText::GeneratedAssociationMethods
  # source://activestorage/7.2.2/lib/active_storage/attached/model.rb#211
  def embeds; end

  # source://activestorage/7.2.2/lib/active_storage/attached/model.rb#216
...
class ActionView::Helpers::FormBuilder
  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1717
  def initialize(object_name, object, template, options); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2649
  def button(value = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2474
  def check_box(method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#908
  def collection_check_boxes(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#920
  def collection_radio_buttons(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#860
  def collection_select(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2042
  def color_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2070
  def date_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/date_helper.rb#1237
  def date_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2084
  def datetime_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2091
  def datetime_local_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/date_helper.rb#1261
  def datetime_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2119
  def email_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2670
  def emitted_hidden_id?; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1682
  ...
  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1774
  def field_id(method, *suffixes, namespace: T.unsafe(nil), index: T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1794
  def field_name(method, *methods, multiple: T.unsafe(nil), index: T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2328
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2290
  def fields_for(record_name, record_object = T.unsafe(nil), fields_options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2557
  def file_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#872
  def grouped_collection_select(method, collection, group_method, group_label_method, option_key_method, option_value_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2518
  def hidden_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1754
  def id; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1694
  def index; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2405
  def label(method, text = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2098
  def month_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1694
  def multipart; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1697
  def multipart=(multipart); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1694
  def multipart?; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2126
  def number_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1692
  def object; end
  ...
  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2028
  def password_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2063
  def phone_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2496
  def radio_button(method, tag_value, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2133
  def range_field(method, options = T.unsafe(nil)); end

  def rich_text_area(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2049
  def search_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#848
  def select(method, choices = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2589
  def submit(value = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2056
  def telephone_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2035
  def text_area(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2021
  def text_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2077
  def time_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/date_helper.rb#1249
  def time_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#884
  def time_zone_select(method, priority_zones = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1713
  def to_model; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1709
  def to_partial_path; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2112
  def url_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2105
  def week_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_options_helper.rb#896
  def weekday_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  private

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2755
  def convert_to_legacy_options(options); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2737
  def fields_for_nested_model(name, object, fields_options, block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2708
  def fields_for_with_nested_attributes(association_name, association, options, block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2704
  def nested_attributes_association?(association_name); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2750
  def nested_child_index(name); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2675
  def objectify_options(options); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#2681
  def submit_default_value; end

  class << self
    # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1705
...
module ActionView::Helpers::FormHelper
  ...
  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1588
  def _object_for_form_builder(object); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1345
  def check_box(object_name, method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1375
  def color_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1439
  def date_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1512
  ...
  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1566
  def email_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1079
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1028
  def fields_for(record_name, record_object = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1247
  def file_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#435
  def form_for(record, options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#755
  def form_with(model: T.unsafe(nil), scope: T.unsafe(nil), url: T.unsafe(nil), format: T.unsafe(nil), **options, &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#481
  def form_with_generates_ids; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#481
  def form_with_generates_ids=(val); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#479
  def form_with_generates_remote_forms; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#479
  def form_with_generates_remote_forms=(val); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1214
  def hidden_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1151
  def label(object_name, method, content_or_options = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1531
  def month_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#483
  def multiple_file_field_include_hidden; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#483
  def multiple_file_field_include_hidden=(val); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1575
  def number_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1196
  def password_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1407
  def phone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1367
  def radio_button(object_name, method, tag_value, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1584
  def range_field(object_name, method, options = T.unsafe(nil)); end

  def rich_text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1398
  def search_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1407
  def telephone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1277
  def text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1175
  def text_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1477
  def time_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1557
  def url_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1548
  def week_field(object_name, method, options = T.unsafe(nil)); end

  private

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#465
  def apply_form_for_options!(object, options); end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1622
  def default_form_builder_class; end

  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1593
  ...
  # source://actionview/7.2.2/lib/action_view/helpers/form_helper.rb#1608
