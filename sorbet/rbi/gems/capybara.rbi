...
module Capybara::RSpecMatchers
  ...
  def have_all_of_selectors(*, **, &); end
  def have_ancestor(*, **, &); end
  def have_any_of_selectors(*, **, &); end
  ...
  def have_element(locator = nil, **options, &optional_filter_block); end
  ...
  def have_none_of_selectors(*, **, &); end
  def have_select(locator = nil, **options, &optional_filter_block); end
  def have_selector(*, **, &); end
  def have_sibling(*, **, &); end
