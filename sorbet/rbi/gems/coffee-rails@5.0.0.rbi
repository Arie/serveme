...
# source://coffee-rails//lib/coffee/rails/js_hook.rb#1
module Coffee; end

# source://coffee-rails//lib/coffee/rails/js_hook.rb#2
module Coffee::Rails; end

# source://coffee-rails//lib/coffee/rails/engine.rb#7
class Coffee::Rails::Engine < ::Rails::Engine; end

# source://coffee-rails//lib/coffee/rails/js_hook.rb#3
module Coffee::Rails::JsHook
  extend ::ActiveSupport::Concern
end

# source://coffee-rails//lib/coffee/rails/template_handler.rb#3
class Coffee::Rails::TemplateHandler
  class << self
    # source://coffee-rails//lib/coffee/rails/template_handler.rb#8
    def call(template, source = T.unsafe(nil)); end

    # source://coffee-rails//lib/coffee/rails/template_handler.rb#4
    def erb_handler; end
  end
end

# source://coffee-rails//lib/coffee/rails/version.rb#3
