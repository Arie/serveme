...
class CSV
  ...
  #   end
  #
  # pkg:gem/csv#lib/csv.rb:2494
  def <<(row); end

  # pkg:gem/csv#lib/csv.rb:2498
  def add_row(row); end

  # pkg:gem/csv#lib/csv.rb:2387
  def binmode(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/csv#lib/csv.rb:2394
  def binmode?; end
  ...
  #
  # pkg:gem/csv#lib/csv.rb:2325
  def encoding; end

  # pkg:gem/csv#lib/csv.rb:2433
  def eof; end

  # pkg:gem/csv#lib/csv.rb:2430
  def eof?; end
  ...
  #
  # pkg:gem/csv#lib/csv.rb:2305
  def force_quotes?; end

  # pkg:gem/csv#lib/csv.rb:2387
  def fsync(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/csv#lib/csv.rb:2790
  def gets; end
  ...
  #   s = csv.inspect
  #
  # pkg:gem/csv#lib/csv.rb:2801
  def inspect; end

  # pkg:gem/csv#lib/csv.rb:2387
  def internal_encoding(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/csv#lib/csv.rb:2407
  def ioctl(*args); end
  ...
  # Since 3.2.3.
  #
  # pkg:gem/csv#lib/csv.rb:2186
  def max_field_size; end

  # pkg:gem/csv#lib/csv.rb:2412
  def path; end
  ...
  #   csv.read
  #
  # pkg:gem/csv#lib/csv.rb:2711
  def read; end

  # pkg:gem/csv#lib/csv.rb:2791
  def readline; end

  # pkg:gem/csv#lib/csv.rb:2719
  def readlines; end
  ...
  #
  # pkg:gem/csv#lib/csv.rb:2257
  def return_headers?; end

  # Rewinds the underlying IO object and resets CSV's lineno() counter.
  #
  # pkg:gem/csv#lib/csv.rb:2436
  def rewind; end
  ...
  #
  # pkg:gem/csv#lib/csv.rb:2196
  def skip_lines; end

  # pkg:gem/csv#lib/csv.rb:2416
  def stat(*args); end
  ...
  # pkg:gem/csv#lib/csv.rb:2421
  def to_i; end

  # pkg:gem/csv#lib/csv.rb:2426
  def to_io; end
  ...
  # shortcut.
  #
  # pkg:gem/csv#lib/csv.rb:2878
  def convert_fields(fields, headers = T.unsafe(nil)); end

  # pkg:gem/csv#lib/csv.rb:2841
  def determine_encoding(encoding, internal_encoding); end

  # pkg:gem/csv#lib/csv.rb:2911
  def header_fields_converter; end

  # pkg:gem/csv#lib/csv.rb:2856
  def normalize_converters(converters); end

  # pkg:gem/csv#lib/csv.rb:2941
  def parser; end

  # pkg:gem/csv#lib/csv.rb:2899
  def parser_fields_converter; end

  # pkg:gem/csv#lib/csv.rb:2945
  def parser_options; end

  # Returns the encoding of the internal IO object.
  #
  # pkg:gem/csv#lib/csv.rb:2889
  def raw_encoding; end

  # pkg:gem/csv#lib/csv.rb:2950
  def writer; end

  # pkg:gem/csv#lib/csv.rb:2924
  def writer_fields_converter; end

  # pkg:gem/csv#lib/csv.rb:2954
...
class CSV::Parser
  ...
  # pkg:gem/csv#lib/csv/parser.rb:452
  def use_headers?; end
  ...
  #
  # pkg:gem/csv#lib/csv/parser.rb:1299
  def add_unconverted_fields(row, fields); end

  # pkg:gem/csv#lib/csv/parser.rb:811
  def adjust_headers(headers, quoted_fields); end

  # pkg:gem/csv#lib/csv/parser.rb:886
  def build_scanner; end

  # pkg:gem/csv#lib/csv/parser.rb:733
  def detect_row_separator(sample, cr, lf); end

  # pkg:gem/csv#lib/csv/parser.rb:1270
  def emit_row(row, quoted_fields = T.unsafe(nil), &block); end

  # pkg:gem/csv#lib/csv/parser.rb:1255
  def ignore_broken_line; end

  # pkg:gem/csv#lib/csv/parser.rb:763
  def last_line; end

  # pkg:gem/csv#lib/csv/parser.rb:828
  def may_quoted?; end

  # pkg:gem/csv#lib/csv/parser.rb:1210
  def parse_column_end; end

  # pkg:gem/csv#lib/csv/parser.rb:1110
  def parse_column_value; end

  # pkg:gem/csv#lib/csv/parser.rb:797
  def parse_headers(row); end

  # pkg:gem/csv#lib/csv/parser.rb:950
  def parse_no_quote(&block); end

  # pkg:gem/csv#lib/csv/parser.rb:979
  def parse_quotable_loose(&block); end

  # pkg:gem/csv#lib/csv/parser.rb:1040
  def parse_quotable_robust(&block); end

  # pkg:gem/csv#lib/csv/parser.rb:1168
  def parse_quoted_column_value; end

  # pkg:gem/csv#lib/csv/parser.rb:1224
  def parse_row_end; end

  # pkg:gem/csv#lib/csv/parser.rb:1140
  def parse_unquoted_column_value; end

  # A set of tasks to prepare the file in order to parse it
  #
  # pkg:gem/csv#lib/csv/parser.rb:458
  def prepare; end

  # pkg:gem/csv#lib/csv/parser.rb:513
  def prepare_backslash; end

  # pkg:gem/csv#lib/csv/parser.rb:771
  def prepare_header; end

  # pkg:gem/csv#lib/csv/parser.rb:757
  def prepare_line; end

  # pkg:gem/csv#lib/csv/parser.rb:817
  def prepare_parser; end

  # pkg:gem/csv#lib/csv/parser.rb:497
  def prepare_quote_character; end

  # pkg:gem/csv#lib/csv/parser.rb:653
  def prepare_quoted; end

  # pkg:gem/csv#lib/csv/parser.rb:585
  def prepare_separators; end

  # pkg:gem/csv#lib/csv/parser.rb:528
  def prepare_skip_lines; end

  # pkg:gem/csv#lib/csv/parser.rb:545
  def prepare_strip; end

  # pkg:gem/csv#lib/csv/parser.rb:680
  def prepare_unquoted; end

  # pkg:gem/csv#lib/csv/parser.rb:473
  def prepare_variable; end

  # pkg:gem/csv#lib/csv/parser.rb:693
  def resolve_row_separator(separator); end

  # pkg:gem/csv#lib/csv/parser.rb:930
  def skip_line?(line); end

  # pkg:gem/csv#lib/csv/parser.rb:913
  def skip_needless_lines; end

  # pkg:gem/csv#lib/csv/parser.rb:1261
  def start_row; end

  # pkg:gem/csv#lib/csv/parser.rb:1237
  def strip_value(value); end

  # pkg:gem/csv#lib/csv/parser.rb:942
  ...
  # parse the input.
  #
  # pkg:gem/csv#lib/csv/parser.rb:635
...
# pkg:gem/csv#lib/csv/parser.rb:860
CSV::Parser::SCANNER_TEST = T.let(T.unsafe(nil), FalseClass)

# pkg:gem/csv#lib/csv/parser.rb:582
...
class CSV::Parser::UnoptimizedStringIO
  # pkg:gem/csv#lib/csv/parser.rb:843
  def initialize(string); end

  # pkg:gem/csv#lib/csv/parser.rb:851
  def each_line(*args, &block); end

  # pkg:gem/csv#lib/csv/parser.rb:855
  def eof?; end

  # pkg:gem/csv#lib/csv/parser.rb:847
  def gets(*args); end
end
...
class CSV::Row
  ...
  # of the row.
  #
  # pkg:gem/csv#lib/csv/row.rb:706
  def deconstruct; end
  ...
  #
  # pkg:gem/csv#lib/csv/row.rb:691
  ...
  #   row.dig(5) # => nil
  #
  # pkg:gem/csv#lib/csv/row.rb:739
  ...
  #
  # pkg:gem/csv#lib/csv/row.rb:764
  def inspect; end
  ...
  # pkg:gem/csv#lib/csv/row.rb:699
  ...
  #   row.to_csv # => "foo,0\n"
  #
  # pkg:gem/csv#lib/csv/row.rb:718
  def to_csv(**options); end
  ...
  # pkg:gem/csv#lib/csv/row.rb:684
  def to_hash; end

  # pkg:gem/csv#lib/csv/row.rb:721
...
# pkg:gem/csv#lib/csv.rb:2130
class CSV::TSV < ::CSV
  # pkg:gem/csv#lib/csv.rb:2131
