...
# source://cucumber-gherkin//lib/gherkin/dialect.rb#6
...
class Gherkin::Dialect
  ...
  #
  # source://cucumber-gherkin//lib/gherkin/dialect.rb#15
  def initialize(spec); end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#55
  def and_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#39
  def background_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#59
  def but_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#35
  def examples_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#19
  def feature_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#43
  def given_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#23
  def rule_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#27
  def scenario_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#31
  def scenario_outline_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#51
  def then_keywords; end

  # source://cucumber-gherkin//lib/gherkin/dialect.rb#47
  def when_keywords; end

  class << self
    # source://cucumber-gherkin//lib/gherkin/dialect.rb#9
    def for(name); end
  end
end
...
# source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#5
class Gherkin::Pickles::Compiler
  ...
  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#10
  def compile(gherkin_document, source); end

  private

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#24
  def compile_feature(pickles, language, tags, feature, source); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#42
  def compile_rule(pickles, language, feature_tags, feature_background_steps, rule, source); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#60
  def compile_scenario(inherited_tags, background_steps, scenario, language, pickles, source); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#86
  def compile_scenario_outline(inherited_tags, background_steps, scenario, language, pickles, source); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#130
  def interpolate(name, variable_cells, value_cells); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#165
  def pickle_data_table(data_table, variable_cells, value_cells); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#179
  def pickle_doc_string(doc_string, variable_cells, value_cells); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#138
  def pickle_step_props(step, variable_cells, values_row, keyword_type); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#193
  def pickle_tag(tag); end

  # source://cucumber-gherkin//lib/gherkin/pickles/compiler.rb#189
...
class Gherkin::Query
  ...
  # @raise [AstNodeNotLocatedException]
  #
  # source://cucumber-gherkin//lib/gherkin/query.rb#13
  def scenario_parent_locations(scenario_node_id); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#9
  def update(message); end

  private

  # source://cucumber-gherkin//lib/gherkin/query.rb#75
  def store_node_location(node); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#71
  def store_nodes_location(nodes); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#45
  def update_background(parent, background); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#25
  def update_feature(feature); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#36
  def update_rule(feature, rule); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#50
  def update_scenario(feature, rule, scenario); end

  # source://cucumber-gherkin//lib/gherkin/query.rb#67
...
class Gherkin::TokenMatcher
  ...
  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#92
  def _match_DocStringSeparator(token, separator, is_open); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#41
  def match_BackgroundLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#63
  def match_Comment(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#81
  def match_DocStringSeparator(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#109
  def match_EOF(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#57
  def match_Empty(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#45
  def match_ExamplesLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#28
  def match_FeatureLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#70
  def match_Language(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#115
  def match_Other(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#32
  def match_RuleLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#36
  def match_ScenarioLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#121
  def match_StepLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#49
  def match_TableRow(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#21
  def match_TagLine(token); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#15
  def reset; end

  private

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#146
  ...
  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#169
  def match_title_line(token, token_type, keywords); end

  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#179
  ...
  # source://cucumber-gherkin//lib/gherkin/token_matcher.rb#190
  def unescape_docstring(text); end
end

# source://cucumber-gherkin//lib/gherkin/token_matcher.rb#7
