...
module FFI
  ...
  class << self
    # source://ffi/1.17.0/lib/ffi/types.rb#62
    def add_typedef(old, add); end

    # source://ffi/1.17.0/lib/ffi/errno.rb#34
    def errno; end

    # source://ffi/1.17.0/lib/ffi/errno.rb#40
    def errno=(error); end

    # @raise [TypeError]
    #
    # source://ffi/1.17.0/lib/ffi/types.rb#76
    def find_type(name, type_map = T.unsafe(nil)); end

    # source://ffi/1.17.0/lib/ffi/compat.rb#35
    def make_shareable(obj); end

    # source://ffi/1.17.0/lib/ffi/library.rb#46
    def map_library_name(lib); end

    # source://ffi/1.17.0/lib/ffi/types.rb#101
    def type_size(type); end

    # source://ffi/1.17.0/lib/ffi/types.rb#56
    def typedef(old, add); end

    private

    # source://ffi/1.17.0/lib/ffi/types.rb#66
