...
class MaxMind::GeoIP2::Client
  ...
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:161
  ...
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:202
  ...
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:246
  def insights(ip_address = T.unsafe(nil)); end

  private

  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:283
  def get(endpoint, ip_address); end

  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:313
  def handle_client_error(endpoint, status, body, is_json); end

  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:348
  def handle_success(endpoint, body, is_json); end

  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:262
  def make_http_client; end

  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/client.rb:252
...
class MaxMind::GeoIP2::Model::AnonymousPlus < ::MaxMind::GeoIP2::Model::AnonymousIP
  ...
  # @return [String, nil]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/model/anonymous_plus.rb:41
...
#
# pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:14
class MaxMind::GeoIP2::Record::Anonymizer < ::MaxMind::GeoIP2::Record::Abstract
  # @!visibility private
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:23
  def initialize(record); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:42
  def anonymous?; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:53
  def anonymous_vpn?; end
  ...
  # @return [Integer, nil]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:34
  def confidence; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:62
  def hosting_provider?; end
  ...
  #   or nil if the date is not available.
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:97
  def network_last_seen; end
  ...
  # @return [String, nil]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:115
  def provider_name; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:70
  def public_proxy?; end
  ...
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:20
  def residential; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:79
  def residential_proxy?; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer.rb:87
  def tor_exit_node?; end
end
...
# service.
#
# pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer_feed.rb:14
class MaxMind::GeoIP2::Record::AnonymizerFeed < ::MaxMind::GeoIP2::Record::Abstract
  # A score ranging from 1 to 99 that represents our percent confidence
  ...
  # @return [Integer, nil]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer_feed.rb:20
  def confidence; end
  ...
  #   or nil if the date is not available.
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer_feed.rb:30
  def network_last_seen; end
  ...
  # @return [String, nil]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/anonymizer_feed.rb:47
  def provider_name; end
end
...
class MaxMind::GeoIP2::Record::Traits < ::MaxMind::GeoIP2::Record::Abstract
  ...
  # @return [String, nil]
  #
  # pkg:gem/maxmind-geoip2#lib/maxmind/geoip2/record/traits.rb:283
  def user_type; end
end
