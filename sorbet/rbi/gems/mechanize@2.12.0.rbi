...
class Mechanize::HTTP::Agent
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1114
  def ca_file; end

  # Sets the path to an OpenSSL CA certificate file
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1119
  def ca_file=(ca_file); end

  # The SSL certificate store used for validating connections
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1124
  def cert_store; end
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1140
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#526
  def disable_keep_alive(request); end

  # source://mechanize//lib/mechanize/http/agent.rb#530
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1048
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1204
  def idle_timeout; end

  # Sets the connection idle timeout for persistent connections
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1209
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1244
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1258
  def log; end

  # source://mechanize//lib/mechanize/http/agent.rb#1302
  ...
  # An OpenSSL private key or the path to a private key
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1151
  def private_key; end

  # Sets the client's private key
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1156
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#552
  def request_add_headers(request, headers = T.unsafe(nil)); end

  # source://mechanize//lib/mechanize/http/agent.rb#569
  def request_auth(request, uri); end

  # source://mechanize//lib/mechanize/http/agent.rb#585
  def request_auth_digest(request, uri, realm, base_uri, iis); end

  # source://mechanize//lib/mechanize/http/agent.rb#594
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#604
  def request_host(request, uri); end

  # source://mechanize//lib/mechanize/http/agent.rb#611
  def request_language_charset(request); end

  # Log specified headers for the request
  #
  # source://mechanize//lib/mechanize/http/agent.rb#616
  ...
  # major browsers do.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#629
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1316
  def reset; end

  # source://mechanize//lib/mechanize/http/agent.rb#644
  def resolve(uri, referer = T.unsafe(nil)); end

  # source://mechanize//lib/mechanize/http/agent.rb#735
  def resolve_parameters(uri, method, parameters); end

  # source://mechanize//lib/mechanize/http/agent.rb#767
  def response_authenticate(response, page, uri, request, headers, params, referer); end

  # source://mechanize//lib/mechanize/http/agent.rb#844
  def response_content_encoding(response, body_io); end

  # source://mechanize//lib/mechanize/http/agent.rb#888
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#930
  def response_log(response); end

  # source://mechanize//lib/mechanize/http/agent.rb#941
  def response_parse(response, body_io, uri); end

  # @raise [Mechanize::ResponseCodeError]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#945
  def response_read(response, request, uri); end

  # @raise [Mechanize::RedirectLimitReachedError]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1004
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1068
  ...
  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1086
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1092
  def robots_error(url); end

  # Raises the error if there is an error in fetching or parsing robots.txt of
  # the site +url+.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1098
  def robots_error!(url); end
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1103
  def robots_reset(url); end

  # source://mechanize//lib/mechanize/http/agent.rb#904
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#723
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1267
  ...
  # SSL version to use
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1167
  def ssl_version; end

  # Sets the SSL version to use
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1172
  def ssl_version=(ssl_version); end

  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1309
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1192
  def verify_mode; end

  # Sets the mode for verifying SSL connections
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1197
  def verify_mode=(verify_mode); end
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1107
  def webrobots; end
end
...
# :section: Robots
#
# source://mechanize//lib/mechanize/http/agent.rb#1046
