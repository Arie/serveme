...
class MultiJson::Adapter
  ...
  class << self
    # source://multi_json//lib/multi_json/adapter.rb#13
    def defaults(action, value); end

    # source://multi_json//lib/multi_json/adapter.rb#25
    def dump(object, options = T.unsafe(nil)); end
    ...
    # @return [Boolean]
    #
    # source://multi_json//lib/multi_json/adapter.rb#31
    def blank?(input); end

    # source://multi_json//lib/multi_json/adapter.rb#37
    ...
    # source://multi_json//lib/multi_json/adapter.rb#51
    def options_without_adapter(options); end
  end
end
...
class MultiJson::Adapters::JsonGem < ::MultiJson::Adapter
  # source://multi_json//lib/multi_json/adapters/json_gem.rb#27
  def dump(object, options = T.unsafe(nil)); end

  # source://multi_json//lib/multi_json/adapters/json_gem.rb#20
  def load(string, options = T.unsafe(nil)); end

  class << self
    # source://multi_json//lib/multi_json/adapters/json_gem.rb#10
