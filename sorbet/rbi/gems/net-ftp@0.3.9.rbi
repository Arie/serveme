...
class Net::FTP < ::Net::Protocol
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#964
  ...
  #
  # source://net-ftp//lib/net/ftp.rb#1267
  def getdir; end
  ...
  # The server's last response code.
  #
  # source://net-ftp//lib/net/ftp.rb#152
  def lastresp; end
...
class Net::FTP::BufferedSSLSocket < ::Net::FTP::BufferedSocket
  # source://net-ftp//lib/net/ftp.rb#1552
  def send(mesg, flags, dest = T.unsafe(nil)); end

  # source://net-ftp//lib/net/ftp.rb#1547
