...
# - #quote
#
# pkg:gem/net-ftp#lib/net/ftp.rb:84
class Net::FTP < ::Net::Protocol
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:402
  def connect(host, port = T.unsafe(nil)); end

  # When +true+, all traffic to and from the server is written
  # to +$stdout+.  Default: +false+.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:111
  def debug_mode; end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:116
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1488
  def debug_print(msg); end

  # Deletes a file on the server.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1180
  def delete(filename); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:964
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1363
  def features; end

  # Retrieves +remotefile+ in whatever mode the session is set (text or
  # binary).  See #gettextfile and #getbinaryfile.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:849
  ...
  # line at a time.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:823
  def gettextfile(remotefile, localfile = T.unsafe(nil), &block); end

  # Issues the HELP command.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1326
  def help(arg = T.unsafe(nil)); end

  # The server's last response.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:155
  def last_response; end

  # The server's last response code.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:151
  def last_response_code; end

  # pkg:gem/net-ftp#lib/net/ftp.rb:152
  def lastresp; end

  # Returns an array of file information in the directory (the output is like
  # `ls -l`).  If a block is given, it iterates through the listing.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:949
  def list(*args, &block); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1251
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1316
  def mdtm(filename); end

  # Creates a remote directory.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1238
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1154
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1346
  def noop; end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:126
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1386
  def option(name, params = T.unsafe(nil)); end

  # When +true+, the connection is in passive mode.  Default: +true+.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:103
  def passive; end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:910
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:863
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:895
  def puttextfile(localfile, remotefile = T.unsafe(nil), &block); end

  # Returns the current remote directory.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1263
  def pwd; end

  # Exits the FTP session.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1337
  def quit; end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1248
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:139
  def read_timeout; end

  # Setter for the read_timeout attribute.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:142
  def read_timeout=(sec); end

  # Renames a file on the server.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1169
  def rename(fromname, toname); end

  # Sets or retrieves the +resume+ status, which decides whether incomplete
  # transfers are resumed or restarted.  Default: +false+.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:120
  def resume; end
  ...
  # (such as "RETR myfile").
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:666
  ...
  # (such as "RETR myfile").
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:691
  def retrlines(cmd); end

  # Obsolete
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:352
  def return_code; end

  # Obsolete
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:358
  def return_code=(s); end

  # Removes a remote directory.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1256
  def rmdir(dirname); end

  # Sends a command and returns the response.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:523
  def sendcmd(cmd); end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:432
  def set_socket(sock, get_greeting = T.unsafe(nil)); end

  # Issues a SITE command.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1353
  def site(arg); end

  # Returns the size of the given (remote) filename.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1217
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:133
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1300
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:716
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:752
  def storlines(cmd, file); end

  # Returns system information.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1272
  def system; end

  # When +true+, use the IP address in PASV responses.  Otherwise, it uses
  # the same IP address for the control connection.  Default: +false+.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:107
  def use_pasv_ip; end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:533
  def voidcmd(cmd); end

  # The server's welcome message.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:148
  def welcome; end

  private

  # pkg:gem/net-ftp#lib/net/ftp.rb:1209
  def get_body(resp); end

  # Reads a line from the sock.  If EOF, then it will raise EOFError
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:465
  def getline; end

  # Receive a section of lines until the response code's match.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:474
  ...
  # FTPProtoError
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:492
  def getresp; end

  # sends the appropriate command to enable a passive connection
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:561
  def makepasv; end

  # Constructs a TCPServer socket
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:555
  def makeport; end
  ...
  # returned.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:367
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1421
  ...
  # Returns host and port.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1461
  ...
  # Returns host and port.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1477
  def parse257(resp); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1112
  def parse_mlsx_entry(entry); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1438
  def parse_pasv_ipv4_host(s); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1443
  def parse_pasv_ipv6_host(s); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1450
  def parse_pasv_port(s); end

  # Ensures that +line+ has a control return / line feed (CRLF) and writes
  # it to the socket.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:454
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:443
  def sanitize(s); end
  ...
  # equal 2.
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:512
  def voidresp; end
  ...
  # +newmode+ is either +true+ or +false+
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:340
  ...
  class << self
    ...
    # Default: +true+.
    #
    # pkg:gem/net-ftp#lib/net/ftp.rb:165
    def default_passive; end

    # When +true+, connections are in passive mode per default.
    # Default: +true+.
    #
    # pkg:gem/net-ftp#lib/net/ftp.rb:159
    ...
    #
    # pkg:gem/net-ftp#lib/net/ftp.rb:175
    def open(host, *args); end
  end
end

# pkg:gem/net-ftp#lib/net/ftp.rb:1545
class Net::FTP::BufferedSSLSocket < ::Net::FTP::BufferedSocket
  # pkg:gem/net-ftp#lib/net/ftp.rb:1552
  def send(mesg, flags, dest = T.unsafe(nil)); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1547
  def shutdown(*args); end
end

# pkg:gem/net-ftp#lib/net/ftp.rb:1509
class Net::FTP::BufferedSocket < ::Net::BufferedIO
  # pkg:gem/net-ftp#lib/net/ftp.rb:1511
  def addr(*args); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1530
  def gets; end
  ...
  # pkg:gem/net-ftp#lib/net/ftp.rb:1516
  def read(len = T.unsafe(nil)); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1535
  def readline; end
...
class Net::FTP::MLSxEntry
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1047
  def listable?; end
  ...
  #
  # pkg:gem/net-ftp#lib/net/ftp.rb:1077
  def writable?; end
end

# :stopdoc:
#
# pkg:gem/net-ftp#lib/net/ftp.rb:1493
class Net::FTP::NullSocket
  # pkg:gem/net-ftp#lib/net/ftp.rb:1501
  def close; end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1497
  def closed?; end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1504
  def method_missing(mid, *args); end

  # pkg:gem/net-ftp#lib/net/ftp.rb:1494
  def read_timeout=(sec); end
end

# :stopdoc:
#
# pkg:gem/net-ftp#lib/net/ftp.rb:92
