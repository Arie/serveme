...
module Net::SSH
  class << self
    # source://net-ssh//lib/net/ssh.rb#295
    ...
    #
    # source://net-ssh//lib/net/ssh.rb#285
    ...
    # local username
    #
    # source://net-ssh//lib/net/ssh.rb#222
    def start(host, user = T.unsafe(nil), options = T.unsafe(nil), &block); end

    private

    # source://net-ssh//lib/net/ssh.rb#308
    def _sanitize_options(options); end

    # source://net-ssh//lib/net/ssh.rb#317
...
# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#25
class Net::SSH::Authentication::ED25519::OpenSSHPrivateKeyLoader
  class << self
    # @raise [ArgumentError]
    #
    # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#43
...
# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#32
class Net::SSH::Authentication::ED25519::OpenSSHPrivateKeyLoader::DecryptError < ::ArgumentError
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#33
  def initialize(message, encrypted_key: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#38
...
# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#29
Net::SSH::Authentication::ED25519::OpenSSHPrivateKeyLoader::MEND = T.let(T.unsafe(nil), String)

# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#141
class Net::SSH::Authentication::ED25519::PrivKey
  # @return [PrivKey] a new instance of PrivKey
  #
  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#150
  def initialize(buffer); end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#171
  def public_key; end
  ...
  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#175
  def ssh_do_sign(data, sig_alg = T.unsafe(nil)); end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#167
  def ssh_signature_type; end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#163
  def ssh_type; end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#159
  def to_blob; end

  class << self
    # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#179
...
# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#145
Net::SSH::Authentication::ED25519::PrivKey::MEND = T.let(T.unsafe(nil), String)

# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#106
class Net::SSH::Authentication::ED25519::PubKey
  include ::Net::SSH::Authentication::PubKeyFingerprint

  # @return [PubKey] a new instance of PubKey
  #
  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#111
  def initialize(data); end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#131
  def ssh_do_verify(sig, data, options = T.unsafe(nil)); end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#127
  def ssh_signature_type; end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#123
  def ssh_type; end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#119
  def to_blob; end

  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#135
  def to_pem; end
  ...
  class << self
    # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#115
    def read_keyblob(buffer); end
  end
end

# source://net-ssh//lib/net/ssh/authentication/ed25519.rb#16
class Net::SSH::Authentication::ED25519::SigningKeyFromFile < ::SimpleDelegator
  ...
  #
  # source://net-ssh//lib/net/ssh/authentication/ed25519.rb#17
...
class Net::SSH::Connection::Session
  ...
  # source://net-sftp/4.0.0/lib/net/sftp.rb#71
