...
#
# pkg:gem/parallel_tests#lib/parallel_tests/railtie.rb:3
module ParallelTests
  class << self
    # copied from http://github.com/carlhuda/bundler Bundler::SharedHelpers#find_gemfile
    #
    # pkg:gem/parallel_tests#lib/parallel_tests.rb:66
    def bundler_enabled?; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:111
    def delta; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:28
    def determine_multiple(multiple); end

    # used by external libraries, do not rename or change api
    #
    # pkg:gem/parallel_tests#lib/parallel_tests.rb:18
    def determine_number_of_processes(count); end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:82
    def first_process?; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:86
    def last_process?; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:107
    def now; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:103
    def number_of_running_processes; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:55
    def pid_file_path; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:51
    def pids; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:59
    def stop_all_processes; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:98
    def wait_for_other_processes_to_finish; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:38
    def with_pid_file; end

    # pkg:gem/parallel_tests#lib/parallel_tests.rb:94
    def with_ruby_binary(command); end
  end
end

# pkg:gem/parallel_tests#lib/parallel_tests/cli.rb:9
class ParallelTests::CLI
  # pkg:gem/parallel_tests#lib/parallel_tests/cli.rb:10
  def run(argv); end
...
# pkg:gem/parallel_tests#lib/parallel_tests.rb:9
ParallelTests::DEFAULT_MULTIPLY_PROCESSES = T.let(T.unsafe(nil), Float)

# pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:3
class ParallelTests::Grouper
  class << self
    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:10
    def by_scenarios(tests, num_groups, options = T.unsafe(nil)); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:5
    def by_steps(tests, num_groups, options); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:15
    def in_even_groups_by_size(items, num_groups, options = T.unsafe(nil)); end

    private

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:120
    def add_to_group(group, item, size); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:125
    def group_by_features_with_steps(tests, options); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:130
    def group_by_scenarios(tests, options = T.unsafe(nil)); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:135
    def group_features_by_size(items, groups_to_fill); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:102
    def isolate_count(options); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:143
    def items_to_group(items); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:112
    def largest_first(files); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:116
    def smallest_group(groups); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:51
    def specified_groups(options); end

    # pkg:gem/parallel_tests#lib/parallel_tests/grouper.rb:58
    def specify_groups(items, num_groups, options, groups); end
  end
end

# pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:5
class ParallelTests::Pids
  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:8
  def initialize(file_path); end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:13
  def add(pid); end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:28
  def all; end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:23
  def count; end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:18
  def delete(pid); end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:6
  def file_path; end
  ...
  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:39
  def clear; end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:35
  def pids; end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:44
  def read; end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:52
  def save; end

  # pkg:gem/parallel_tests#lib/parallel_tests/pids.rb:56
  def sync(&block); end
end

# pkg:gem/parallel_tests#lib/parallel_tests.rb:8
ParallelTests::RUBY_BINARY = T.let(T.unsafe(nil), String)

# pkg:gem/parallel_tests#lib/parallel_tests/railtie.rb:4
class ParallelTests::Railtie < ::Rails::Railtie; end

# pkg:gem/parallel_tests#lib/parallel_tests/version.rb:3
ParallelTests::VERSION = T.let(T.unsafe(nil), String)

# pkg:gem/parallel_tests#lib/parallel_tests.rb:7
