...
class Psych::Visitors::NoAliasRuby < ::Psych::Visitors::ToRuby
  ...
  #
  # source://psych//lib/psych/visitors/to_ruby.rb#471
  def visit_Psych_Nodes_Alias(o); end
end
...
class Psych::Visitors::ToRuby < ::Psych::Visitors::Visitor
  ...
  # source://psych//lib/psych/visitors/to_ruby.rb#353
  def visit_Psych_Nodes_Alias(o); end

  # source://psych//lib/psych/visitors/to_ruby.rb#345
  def visit_Psych_Nodes_Document(o); end
  ...
  # source://psych//lib/psych/visitors/to_ruby.rb#349
  def visit_Psych_Nodes_Stream(o); end

  private

  # source://psych//lib/psych/visitors/to_ruby.rb#370
  def allocate_anon_data(node, members); end

  # source://psych//lib/psych.rb#15
  def build_exception(_arg0, _arg1); end

  # source://psych//lib/psych/visitors/to_ruby.rb#435
  ...
  # source://psych//lib/psych.rb#15
  def init_data(_arg0, _arg1); end

  # source://psych//lib/psych/visitors/to_ruby.rb#452
  def init_with(o, h, node); end

  # source://psych//lib/psych/visitors/to_ruby.rb#444
  def merge_key(hash, key, val); end

  # source://psych//lib/psych/visitors/to_ruby.rb#359
  def register(node, object); end

  # source://psych//lib/psych/visitors/to_ruby.rb#364
  def register_empty(object); end

  # Convert +klassname+ to a Class
  #
  # source://psych//lib/psych/visitors/to_ruby.rb#465
  def resolve_class(klassname); end

  # source://psych//lib/psych/visitors/to_ruby.rb#447
  def revive(klass, node); end

  # source://psych//lib/psych/visitors/to_ruby.rb#375
  def revive_data_members(hash, o); end

  # source://psych//lib/psych/visitors/to_ruby.rb#384
