...
# source://rack-cache//lib/rack/cache/entity_store.rb#337
Rack::Cache::EntityStore::GAE = Rack::Cache::EntityStore::GAEStore

# source://rack-cache//lib/rack/cache/entity_store.rb#336
Rack::Cache::EntityStore::GAECACHE = Rack::Cache::EntityStore::GAEStore

# source://rack-cache//lib/rack/cache/entity_store.rb#294
class Rack::Cache::EntityStore::GAEStore < ::Rack::Cache::EntityStore
  # @return [GAEStore] a new instance of GAEStore
  #
  # source://rack-cache//lib/rack/cache/entity_store.rb#297
  def initialize(options = T.unsafe(nil)); end

  # Returns the value of attribute cache.
  #
  # source://rack-cache//lib/rack/cache/entity_store.rb#295
  def cache; end

  # @return [Boolean]
  #
  # source://rack-cache//lib/rack/cache/entity_store.rb#302
  def exist?(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#310
  def open(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#325
  def purge(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#306
  def read(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#318
  def write(body, ttl = T.unsafe(nil)); end
...
# source://rack-cache//lib/rack/cache/entity_store.rb#292
...
# source://rack-cache//lib/rack/cache/entity_store.rb#374
...
#
# source://rack-cache//lib/rack/cache/entity_store.rb#347
class Rack::Cache::EntityStore::Noop < ::Rack::Cache::EntityStore
  # @return [Boolean]
  #
  # source://rack-cache//lib/rack/cache/entity_store.rb#348
  def exist?(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#356
  def open(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#365
  def purge(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#352
  def read(key); end

  # source://rack-cache//lib/rack/cache/entity_store.rb#360
  def write(body, ttl = T.unsafe(nil)); end

  class << self
    # source://rack-cache//lib/rack/cache/entity_store.rb#369
    def resolve(uri); end
  end
end

# source://redis-rack-cache/2.2.1/lib/rack/cache/redis_entitystore.rb#92
...
class Rack::Cache::MetaStore
  ...
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#61
  ...
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#187
  def purge(key); end
  ...
  # @raise [NotImplementedError]
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#174
  def read(key); end
  ...
  # @raise [NotImplementedError]
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#181
  ...
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#194
  ...
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#140
  def persist_request(request); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#153
  ...
  # @return [Boolean]
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#161
  ...
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#148
  def restore_response(hash, body = T.unsafe(nil)); end
end

# source://rack-cache//lib/rack/cache/meta_store.rb#291
Rack::Cache::MetaStore::DISK = Rack::Cache::MetaStore::Disk

# source://rack-cache//lib/rack/cache/meta_store.rb#336
class Rack::Cache::MetaStore::Dalli < ::Rack::Cache::MetaStore::MemCacheBase
  # @return [Dalli] a new instance of Dalli
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#337
  def initialize(server = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#358
  def purge(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#347
  def read(key); end

  # Default TTL to zero, interpreted as "don't expire" by Memcached.
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#353
...
# pairs on disk.
#
# source://rack-cache//lib/rack/cache/meta_store.rb#238
class Rack::Cache::MetaStore::Disk < ::Rack::Cache::MetaStore
  # @return [Disk] a new instance of Disk
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#241
  def initialize(root = T.unsafe(nil)); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#264
  def purge(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#246
  def read(key); end
  ...
  # source://rack-cache//lib/rack/cache/meta_store.rb#253
  def write(key, entries, ttl = T.unsafe(nil)); end

  private

  # source://rack-cache//lib/rack/cache/meta_store.rb#273
  def key_path(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#277
  def spread(sha, n = T.unsafe(nil)); end

  class << self
    # source://rack-cache//lib/rack/cache/meta_store.rb#284
    def resolve(uri); end
  end
end

# source://rack-cache//lib/rack/cache/meta_store.rb#292
Rack::Cache::MetaStore::FILE = Rack::Cache::MetaStore::Disk

# source://rack-cache//lib/rack/cache/meta_store.rb#441
Rack::Cache::MetaStore::GAE = Rack::Cache::MetaStore::GAEStore

# source://rack-cache//lib/rack/cache/meta_store.rb#440
Rack::Cache::MetaStore::GAECACHE = Rack::Cache::MetaStore::GAEStore

# source://rack-cache//lib/rack/cache/meta_store.rb#410
class Rack::Cache::MetaStore::GAEStore < ::Rack::Cache::MetaStore
  # @return [GAEStore] a new instance of GAEStore
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#413
  def initialize(options = T.unsafe(nil)); end
  ...
  # source://rack-cache//lib/rack/cache/meta_store.rb#428
  def purge(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#418
  def read(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#423
  def write(key, entries); end

  class << self
    # source://rack-cache//lib/rack/cache/meta_store.rb#434
    def resolve(uri); end
  end
end

# source://rack-cache//lib/rack/cache/meta_store.rb#233
...
#
# source://rack-cache//lib/rack/cache/meta_store.rb#201
class Rack::Cache::MetaStore::Heap < ::Rack::Cache::MetaStore
  # @return [Heap] a new instance of Heap
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#202
  def initialize(hash = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#219
  def purge(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#207
  def read(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#224
  def to_hash; end

  # source://rack-cache//lib/rack/cache/meta_store.rb#215
  def write(key, entries, ttl = T.unsafe(nil)); end

  class << self
    # source://rack-cache//lib/rack/cache/meta_store.rb#228
    def resolve(uri, options = T.unsafe(nil)); end
  end
end

# source://rack-cache//lib/rack/cache/meta_store.rb#234
Rack::Cache::MetaStore::MEM = Rack::Cache::MetaStore::Heap

# source://rack-cache//lib/rack/cache/meta_store.rb#402
...
#
# source://rack-cache//lib/rack/cache/meta_store.rb#297
class Rack::Cache::MetaStore::MemCacheBase < ::Rack::Cache::MetaStore
  ...
  # daemon.
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#302
  def cache; end
  ...
  class << self
    ...
    #
    # source://rack-cache//lib/rack/cache/meta_store.rb#311
    def resolve(uri); end
  end
end

# source://rack-cache//lib/rack/cache/meta_store.rb#364
class Rack::Cache::MetaStore::MemCached < ::Rack::Cache::MetaStore::MemCacheBase
  # @return [MemCached] a new instance of MemCached
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#369
  def initialize(server = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  # source://rack-cache//lib/rack/cache/meta_store.rb#393
  def purge(key); end

  # source://rack-cache//lib/rack/cache/meta_store.rb#380
  def read(key); end

  # Default TTL to zero, interpreted as "don't expire" by Memcached.
  #
  # source://rack-cache//lib/rack/cache/meta_store.rb#388
  def write(key, entries, ttl = T.unsafe(nil)); end
end

# source://redis-rack-cache/2.2.1/lib/rack/cache/redis_metastore.rb#28
