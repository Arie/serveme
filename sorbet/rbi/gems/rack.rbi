...
class Rack::Directory::DirectoryBody < Anonymous_Struct_13
...
class Rack::Multipart::Parser::Collector::MimePart < Anonymous_Struct_14
  def get_data; end
end
...
class Rack::Session::Cookie::SessionId < Anonymous_Delegator_15
  def cookie_value; end
