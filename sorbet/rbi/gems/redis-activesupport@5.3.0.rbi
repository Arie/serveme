...
module ActiveSupport
  # source://activesupport/7.0.5/lib/active_support/json/decoding.rb#9
  def parse_json_times; end

  # source://activesupport/7.0.5/lib/active_support/json/decoding.rb#9
  def parse_json_times=(val); end

  # source://activesupport/7.0.5/lib/active_support.rb#94
  def test_order; end

  # source://activesupport/7.0.5/lib/active_support.rb#94
  def test_order=(val); end

  # source://activesupport/7.0.5/lib/active_support.rb#95
  ...
  class << self
    # source://activesupport/7.0.5/lib/active_support.rb#99
    def cache_format_version; end

    # source://activesupport/7.0.5/lib/active_support.rb#103
    def cache_format_version=(value); end

    # source://activesupport/7.0.5/lib/active_support.rb#88
    def eager_load!; end

    # source://activesupport/7.0.5/lib/active_support.rb#97
    def error_reporter; end

    # source://activesupport/7.0.5/lib/active_support.rb#97
    def error_reporter=(_arg0); end

    # source://activesupport/7.0.5/lib/active_support/json/encoding.rb#8
    def escape_html_entities_in_json(*_arg0, **_arg1, &_arg2); end

    # source://activesupport/7.0.5/lib/active_support/json/encoding.rb#8
    def escape_html_entities_in_json=(arg); end

    # source://activesupport/7.0.5/lib/active_support/gem_version.rb#5
    def gem_version; end
    ...
    # source://activesupport/7.0.5/lib/active_support.rb#107
    def to_time_preserves_timezone; end

    # source://activesupport/7.0.5/lib/active_support.rb#111
    ...
    # source://activesupport/7.0.5/lib/active_support.rb#115
    def utc_to_local_returns_utc_offset_times; end

    # source://activesupport/7.0.5/lib/active_support.rb#119
    def utc_to_local_returns_utc_offset_times=(value); end

    # source://activesupport/7.0.5/lib/active_support/version.rb#7
    def version; end
  end
end
...
module ActiveSupport::Cache
  class << self
    # source://activesupport/7.0.5/lib/active_support/cache.rb#100
    def expand_cache_key(key, namespace = T.unsafe(nil)); end

    # source://activesupport/7.0.5/lib/active_support/cache.rb#41
    def format_version; end

    # source://activesupport/7.0.5/lib/active_support/cache.rb#41
    def format_version=(_arg0); end

    # source://activesupport/7.0.5/lib/active_support/cache.rb#68
    def lookup_store(store = T.unsafe(nil), *parameters); end

    private

    # source://activesupport/7.0.5/lib/active_support/cache.rb#112
    def retrieve_cache_key(key); end

    # source://activesupport/7.0.5/lib/active_support/cache.rb#124
    def retrieve_store_class(store); end
  end
end

# source://activesupport/7.0.5/lib/active_support/cache.rb#27
ActiveSupport::Cache::DEFAULT_COMPRESS_LIMIT = T.let(T.unsafe(nil), Integer)

# source://activesupport/7.0.5/lib/active_support/cache.rb#30
...
# source://activesupport/7.0.5/lib/active_support/cache.rb#25
