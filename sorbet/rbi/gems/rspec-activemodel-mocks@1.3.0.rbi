...
module RSpec::ActiveModel::Mocks::Mocks
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#99
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#274
  def stub_model(model_class, stubs = T.unsafe(nil)); end

  private

  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#310
  def next_id; end
end
...
module RSpec::ActiveModel::Mocks::Mocks::ActiveRecordInstanceMethods
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#62
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#74
  ...
  # @return [Boolean]
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#68
  def new_record?; end
...
# source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#225
module RSpec::ActiveModel::Mocks::Mocks::ActiveRecordStubExtensions
  # Stubs `id` (or other primary key method) to return nil
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#227
  def as_new_record; end
  ...
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#239
  def connection; end
  ...
  # @return [Boolean]
  #
  # source://rspec-activemodel-mocks//lib/rspec/active_model/mocks/mocks.rb#233
  def new_record?; end
end
