...
# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/version.rb:2
module RSpec; end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/version.rb:3
module RSpec::ActiveModel; end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/version.rb:4
module RSpec::ActiveModel::Mocks; end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:7
class RSpec::ActiveModel::Mocks::IllegalDataAccessException < ::StandardError; end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:8
module RSpec::ActiveModel::Mocks::Mocks
  ...
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:99
  ...
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:274
  def stub_model(model_class, stubs = T.unsafe(nil)); end

  private

  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:310
  def next_id; end
end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:9
module RSpec::ActiveModel::Mocks::Mocks::ActiveModelInstanceMethods
  # Stubs `persisted?` to return false and `id` to return nil
  # @return self
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:12
  def as_new_record; end

  # Returns true by default. Override with a stub.
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:19
  def persisted?; end

  # Returns false for names matching <tt>/_before_type_cast$/</tt>,
  # otherwise delegates to super.
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:25
  def respond_to?(message, include_private = T.unsafe(nil)); end
end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:211
module RSpec::ActiveModel::Mocks::Mocks::ActiveModelStubExtensions
  # Stubs `persisted` to return false and `id` to return nil
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:213
  def as_new_record; end

  # Returns `true` by default. Override with a stub.
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:220
  def persisted?; end
end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:48
module RSpec::ActiveModel::Mocks::Mocks::ActiveRecordInstanceMethods
  # Transforms the key to a method and calls it.
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:56
  def [](key); end

  # Rails>4.2 uses _read_attribute internally, as an optimized
  # alternative to record['id']
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:62
  ...
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:74
  def association(association_name); end

  # Stubs `persisted?` to return `false` and `id` to return `nil`.
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:50
  def destroy; end

  # Returns the opposite of `persisted?`
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:68
  def new_record?; end

  # Rails>7.1 added read_attribute for external usage similar to record['id']
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:65
  def read_attribute(key); end
end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:225
module RSpec::ActiveModel::Mocks::Mocks::ActiveRecordStubExtensions
  # Stubs `id` (or other primary key method) to return nil
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:227
  def as_new_record; end
  ...
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:239
  def connection; end

  # Returns the opposite of `persisted?`.
  #
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:233
  def new_record?; end
end
...
# @private
#
# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:35
class RSpec::ActiveModel::Mocks::Mocks::Association
  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:38
  def initialize(association_name); end

  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:36
  def inversed; end

  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:36
  def inversed=(_arg0); end

  # pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/mocks.rb:42
...
# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/version.rb:5
module RSpec::ActiveModel::Mocks::Version; end

# pkg:gem/rspec-activemodel-mocks#lib/rspec/active_model/mocks/version.rb:6
