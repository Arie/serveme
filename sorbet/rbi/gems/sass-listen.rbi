...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/sass-listen/all/sass-listen.rbi
#
# sass-listen-4.0.0
...
class SassListen::Record::SymlinkDetector::Error < RuntimeError
end
...
class SassListen::Adapter::BSD < SassListen::Adapter::Base
...
class SassListen::Adapter::Darwin < SassListen::Adapter::Base
...
class SassListen::Adapter::Linux < SassListen::Adapter::Base
  def _change(event_flags); end
...
class SassListen::Adapter::Polling < SassListen::Adapter::Base
  def _configure(_, &callback); end
  def _process_event(dir, _); end
  def _run; end
end
class SassListen::Adapter::Windows < SassListen::Adapter::Base
...
class SassListen::Event::Processor::Stopped < RuntimeError
end
...
class SassListen::Event::Loop::Error < RuntimeError
end
class SassListen::Event::Loop::Error::NotStarted < SassListen::Event::Loop::Error
end
