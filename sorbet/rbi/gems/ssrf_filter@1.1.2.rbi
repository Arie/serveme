...
# source://ssrf_filter//lib/ssrf_filter/patch/ssl_socket.rb#3
class SsrfFilter
  class << self
    ...
    # source://ssrf_filter//lib/ssrf_filter/ssrf_filter.rb#159
    def host_header(hostname, uri); end

    # @return [Boolean]
    #
    # source://ssrf_filter//lib/ssrf_filter/ssrf_filter.rb#153
    ...
    # @return [Boolean]
    #
    # source://ssrf_filter//lib/ssrf_filter/ssrf_filter.rb#143
    def unsafe_ip_address?(ip_address); end

    # source://ssrf_filter//lib/ssrf_filter/ssrf_filter.rb#214
    def validate_request(request); end

    # source://ssrf_filter//lib/ssrf_filter/ssrf_filter.rb#227
