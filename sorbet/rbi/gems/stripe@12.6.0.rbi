...
module Stripe
  class << self
    ...
    # #set_app_info.
    #
    # source://stripe//lib/stripe.rb#99
    def app_info; end

    # source://stripe//lib/stripe.rb#103
    ...
    #
    # source://stripe//lib/stripe.rb#70
    def config; end
    ...
    # source://stripe//lib/stripe.rb#141
    ...
    def raw_request(method, url, params = T.unsafe(nil), opts = T.unsafe(nil)); end
    ...
    #
    # source://stripe//lib/stripe.rb#112
...
module Stripe::APIOperations::Request
  ...
  # source://stripe//lib/stripe/api_operations/request.rb#117
  def _deprecated_request(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), usage = T.unsafe(nil)); end

  # source://stripe//lib/stripe/api_operations/request.rb#117
  def execute_resource_request(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), usage = T.unsafe(nil)); end

  # source://stripe//lib/stripe/api_operations/request.rb#123
  def execute_resource_request_stream(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), &read_body_chunk_block); end

  private

  # source://stripe//lib/stripe/api_operations/request.rb#132
  def request_stripe_object(method:, path:, params:, opts: T.unsafe(nil), usage: T.unsafe(nil)); end

  class << self
    # @private
    #
    # source://stripe//lib/stripe/api_operations/request.rb#113
    def included(base); end
  end
end
...
module Stripe::APIOperations::Request::ClassMethods
  ...
  # @raise [ArgumentError]
  #
  # source://stripe//lib/stripe/api_operations/request.rb#98
  def error_on_invalid_params(params); end

  # source://stripe//lib/stripe/api_operations/request.rb#84
...
module Stripe::APIOperations::SingletonSave
  ...
  class << self
    # @private
    #
    # source://stripe//lib/stripe/api_operations/singleton_save.rb#72
    def included(base); end
  end
end
...
class Stripe::APIResource < ::Stripe::StripeObject
  ...
  # source://stripe//lib/stripe/api_resource.rb#89
  def refresh; end

  # source://stripe//lib/stripe/api_resource.rb#102
  def request_stripe_object(method:, path:, params:, opts: T.unsafe(nil)); end

  # source://stripe//lib/stripe/api_resource.rb#78
  ...
  # source://stripe//lib/stripe/api_resource.rb#113
  ...
  class << self
    ...
    #
    # source://stripe//lib/stripe/api_resource.rb#74
    ...
    # endpoints.
    #
    # source://stripe//lib/stripe/api_resource.rb#44
...
class Stripe::Account < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/api_resource.rb#45
  ...
  class << self
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#48
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#96
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#106
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_capability(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_external_account(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_person(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#86
...
class Stripe::ApplicationFee < ::Stripe::APIResource
  ...
  class << self
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_refund(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
...
class Stripe::Customer < ::Stripe::APIResource
  ...
  class << self
    ...
    #
    # source://stripe//lib/stripe/resources/customer.rb#27
    def create(params = T.unsafe(nil), opts = T.unsafe(nil)); end
    ...
    # funding instructions will be retrieved. In other words, we will return the same funding instructions each time.
    #
    # source://stripe//lib/stripe/resources/customer.rb#46
    ...
    # Permanently deletes a customer. It cannot be undone. Also immediately cancels any active subscriptions on the customer.
    #
    # source://stripe//lib/stripe/resources/customer.rb#56
    def delete(id, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # Removes the currently applied discount on a customer.
    #
    # source://stripe//lib/stripe/resources/customer.rb#86
    ...
    #
    # source://stripe//lib/stripe/resources/customer.rb#96
    def list(filters = T.unsafe(nil), opts = T.unsafe(nil)); end
    ...
    # Returns a list of PaymentMethods for a given Customer
    #
    # source://stripe//lib/stripe/resources/customer.rb#111
    ...
    # source://stripe//lib/stripe/resources/customer.rb#17
    def object_name; end

    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_balance_transaction(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_cash_balance_transaction(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end

    # Retrieves a PaymentMethod object for a given Customer.
    #
    # source://stripe//lib/stripe/resources/customer.rb#141
    def retrieve_payment_method(customer, payment_method, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_source(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_tax_id(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/customer.rb#150
    def search(params = T.unsafe(nil), opts = T.unsafe(nil)); end
    ...
    #
    # source://stripe//lib/stripe/resources/customer.rb#161
    def update(id, params = T.unsafe(nil), opts = T.unsafe(nil)); end
    ...
    #
    # source://stripe//lib/stripe/resources/customer.rb#171
...
class Stripe::Customer::TestHelpers < ::Stripe::APIResourceTestHelpers
  ...
  #
  # source://stripe//lib/stripe/resources/customer.rb#209
  def fund_cash_balance(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  class << self
    # Create an incoming testmode bank transfer
    #
    # source://stripe//lib/stripe/resources/customer.rb#199
    def fund_cash_balance(customer, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/customer.rb#194
    def resource_class; end
  end
end
...
# source://stripe//lib/stripe.rb#61
...
class Stripe::ListObject < ::Stripe::StripeObject
  ...
  #
  # source://stripe//lib/stripe/list_object.rb#107
  ...
  # was given, the default limit will be fetched again.
  #
  # source://stripe//lib/stripe/list_object.rb#121
  def previous_page(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/list_object.rb#131
  def resource_url; end
  ...
  #
  # source://stripe//lib/stripe/list_object.rb#138
...
class Stripe::Product < ::Stripe::APIResource
  ...
  class << self
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_feature(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
...
# source://stripe//lib/stripe.rb#121
class Stripe::RawRequest
  include ::Stripe::APIOperations::Request
  extend ::Stripe::APIOperations::Request::ClassMethods

  # @return [RawRequest] a new instance of RawRequest
  #
  # source://stripe//lib/stripe.rb#124
  def initialize; end

  # source://stripe//lib/stripe.rb#128
  def execute(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), usage = T.unsafe(nil)); end
end
...
class Stripe::Source < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/source.rb#77
  ...
  class << self
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_source_transaction(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
...
class Stripe::StripeClient
  ...
  # source://stripe//lib/stripe/stripe_client.rb#182
  ...
  # Returns the value of attribute config.
  #
  # source://stripe//lib/stripe/stripe_client.rb#44
  def config; end
  ...
  # source://stripe//lib/stripe/stripe_client.rb#219
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#250
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_client.rb#277
  ...
  # source://stripe//lib/stripe/stripe_client.rb#271
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#519
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#699
  def format_app_info(info); end

  # source://stripe//lib/stripe/stripe_client.rb#689
  def general_api_error(status, body); end

  # source://stripe//lib/stripe/stripe_client.rb#706
  def handle_error_response(http_resp, context); end

  # @raise [APIConnectionError]
  #
  # source://stripe//lib/stripe/stripe_client.rb#834
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#733
  def merge_query_params(query_params, path); end

  # source://stripe//lib/stripe/stripe_client.rb#646
  def notify_request_begin(context); end

  # source://stripe//lib/stripe/stripe_client.rb#661
  def notify_request_end(context, duration, http_status, num_retries, user_data, resp, headers); end

  # source://stripe//lib/stripe/stripe_client.rb#860
  ...
  # source://stripe//lib/stripe/stripe_client.rb#748
  def specific_api_error(resp, error_data, context); end

  # Attempts to look at a response's error code and return an OAuth error if
  # one matches. Will return `nil` if the code isn't recognized.
  #
  # source://stripe//lib/stripe/stripe_client.rb#798
  ...
  class << self
    ...
    #
    # source://stripe//lib/stripe/stripe_client.rb#53
    ...
    # with future non-major changes.
    #
    # source://stripe//lib/stripe/stripe_client.rb#66
    ...
    # with future non-major changes.
    #
    # source://stripe//lib/stripe/stripe_client.rb#386
    def current_thread_context; end

    # A default client for the current thread.
    #
    # source://stripe//lib/stripe/stripe_client.rb#95
    ...
    #
    # source://stripe//lib/stripe/stripe_client.rb#101
    ...
    # with future non-major changes.
    #
    # source://stripe//lib/stripe/stripe_client.rb#407
    ...
    # @return [Boolean]
    #
    # source://stripe//lib/stripe/stripe_client.rb#117
    def should_retry?(error, num_retries:, config: T.unsafe(nil)); end

    # source://stripe//lib/stripe/stripe_client.rb#162
...
#
# source://stripe//lib/stripe/stripe_client.rb#287
...
#
# source://stripe//lib/stripe/stripe_client.rb#291
...
# source://stripe//lib/stripe/stripe_client.rb#298
...
# source://stripe//lib/stripe/stripe_client.rb#316
...
#
# source://stripe//lib/stripe/stripe_client.rb#305
...
# full transparency.
#
# source://stripe//lib/stripe/stripe_client.rb#325
...
class Stripe::StripeClient::StripeRequestMetrics
  ...
  # source://stripe//lib/stripe/stripe_client.rb#1059
  def payload; end
...
class Stripe::StripeClient::ThreadContext
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#350
  def active_client; end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#354
  def default_client; end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#372
  ...
  # source://stripe//lib/stripe/stripe_client.rb#376
...
class Stripe::StripeObject
  ...
  #
  # source://stripe//lib/stripe/stripe_object.rb#98
  def ==(other); end

  # source://stripe//lib/stripe/stripe_object.rb#160
  def [](key); end

  # source://stripe//lib/stripe/stripe_object.rb#164
  def []=(key, value); end

  # source://stripe//lib/stripe/stripe_object.rb#181
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_object.rb#119
  def deleted?; end
  ...
  #
  # source://stripe//lib/stripe/stripe_object.rb#210
  def dirty!; end

  # source://stripe//lib/stripe/stripe_object.rb#202
  def each(&blk); end
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_object.rb#105
  def eql?(other); end

  # As with equality in `#==` and `#eql?`, we hash two Stripe objects to the
  # same value if they're equivalent objects.
  #
  # source://stripe//lib/stripe/stripe_object.rb#112
  def hash; end

  # source://stripe//lib/stripe/stripe_object.rb#127
  def inspect; end

  # source://stripe//lib/stripe/stripe_object.rb#168
  def keys; end
  ...
  # serialized.
  #
  # source://stripe//lib/stripe/stripe_object.rb#222
  def marshal_dump; end

  # Implements custom decoding for Ruby's Marshal. Consumes data that's
  # produced by #marshal_dump.
  #
  # source://stripe//lib/stripe/stripe_object.rb#233
  def marshal_load(data); end

  # source://stripe//lib/stripe/stripe_object.rb#239
  def serialize_params(options = T.unsafe(nil)); end

  # source://stripe//lib/stripe/stripe_object.rb#185
  def to_hash; end

  # source://stripe//lib/stripe/stripe_object.rb#176
  def to_json(*_opts); end

  # source://stripe//lib/stripe/stripe_object.rb#123
  def to_s(*_args); end
  ...
  #
  # source://stripe//lib/stripe/stripe_object.rb#151
  def update_attributes(values, opts = T.unsafe(nil), dirty: T.unsafe(nil)); end

  # source://stripe//lib/stripe/stripe_object.rb#172
  def values; end

  protected

  # source://stripe//lib/stripe/stripe_object.rb#334
  ...
  #   remove accessors.
  #
  # source://stripe//lib/stripe/stripe_object.rb#430
  def initialize_from(values, opts, last_response = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_object.rb#414
  def respond_to_missing?(symbol, include_private = T.unsafe(nil)); end

  # source://stripe//lib/stripe/stripe_object.rb#464
  def serialize_params_value(value, original, unsaved, force, key: T.unsafe(nil)); end

  private

  # source://stripe//lib/stripe/stripe_object.rb#564
  def dirty_value!(value); end

  # Returns a hash of empty values for all the values that are in the given
  # StripeObject.
  #
  # source://stripe//lib/stripe/stripe_object.rb#575
  ...
  class << self
    ...
    # source://stripe//lib/stripe/stripe_object.rb#88
    def construct_from(values, opts = T.unsafe(nil), last_response = T.unsafe(nil)); end

    # A protected field is one that doesn't get an accessor assigned to it
    # (i.e. `obj.public = ...`) and one which is not allowed to be updated via
    # the class level `Model.update(id, { ... })`.
    #
    # source://stripe//lib/stripe/stripe_object.rb#269
    def protected_fields; end
    ...
    #
    # source://stripe//lib/stripe/stripe_object.rb#543
...
#
# source://stripe//lib/stripe/stripe_object.rb#290
...
class Stripe::Transfer < ::Stripe::APIResource
  ...
  class << self
    ...
    # source://stripe//lib/stripe/api_operations/nested_resource.rb#59
    def retrieve_reversal(id, nested_id, params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
...
module Stripe::Util
  class << self
    ...
    def convert_to_stripe_object_with_params(data, params, opts = T.unsafe(nil), last_response = T.unsafe(nil)); end
