...
module Bootsnap
  # source://bootsnap/1.18.6/lib/bootsnap/bundler.rb#6
  def bundler?; end
  ...
  class << self
    # source://bootsnap/1.18.6/lib/bootsnap.rb#44
    def _instrument(event, path); end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#137
    def absolute_path?(path); end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#82
    def default_setup; end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#37
    def instrumentation=(callback); end

    def instrumentation_enabled=(_arg0); end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#24
    def log!; end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#14
    def log_stats!; end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#12
    def logger; end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#28
    def logger=(logger); end

    def rb_get_path(_arg0); end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#48
    ...
    # source://bootsnap/1.18.6/lib/bootsnap.rb#78
    def unload_cache!; end

    private

    # source://bootsnap/1.18.6/lib/bootsnap.rb#159
    def bool_env(key, default: T.unsafe(nil)); end

    # source://bootsnap/1.18.6/lib/bootsnap.rb#155
    def enabled?(key); end
  end
end
...
module Bootsnap::CompileCache
  class << self
    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache.rb#12
    def setup(cache_dir:, iseq:, yaml:, json:, readonly: T.unsafe(nil), revalidation: T.unsafe(nil)); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache.rb#46
    def supported?; end
  end
end
...
module Bootsnap::CompileCache::ISeq
  class << self
    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#10
    def cache_dir; end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#12
    def cache_dir=(cache_dir); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#103
    def compile_option_updated; end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#63
    def fetch(path, cache_dir: T.unsafe(nil)); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#80
    def input_to_output(_data, _kwargs); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#45
    def input_to_storage(_, path); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#110
    def install!(cache_dir); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#72
    def precompile(path); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#52
    def storage_to_output(binary, _args); end

    # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#16
    def supported?; end
  end
end
...
module Bootsnap::CompileCache::ISeq::InstructionSequenceMixin
  # source://bootsnap/1.18.6/lib/bootsnap/compile_cache/iseq.rb#97
