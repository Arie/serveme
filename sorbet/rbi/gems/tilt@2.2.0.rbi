...
# source://tilt//lib/tilt/coffee.rb#43
class Tilt::CoffeeScriptLiterateTemplate < ::Tilt::CoffeeScriptTemplate
  class << self
    # @return [Boolean]
    #
    # source://tilt//lib/tilt/coffee.rb#46
    def literate?; end
  end
end
...
class Tilt::CoffeeScriptTemplate < ::Tilt::StaticTemplate
  ...
  class << self
    ...
    # :nocov:
    #
    # source://tilt//lib/tilt/coffee.rb#19
    def default_no_wrap; end

    # source://tilt//lib/tilt/coffee.rb#24
    def default_no_wrap=(value); end

    # :nocov:
    #
    # @return [Boolean]
    #
    # source://tilt//lib/tilt/coffee.rb#30
    def literate?; end
  end
end
