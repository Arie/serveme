...
class HTTP::Client
  # source://http/5.2.0/lib/http/client.rb#21
  def initialize(default_options = T.unsafe(nil)); end

  # source://http/5.2.0/lib/http/client.rb#64
  def __perform__(req, options); end

  # source://http/5.2.0/lib/http/client.rb#40
  def build_request(verb, uri, opts = T.unsafe(nil)); end

  # source://http/5.2.0/lib/http/client.rb#97
  def close; end
  ...
  # source://http/5.2.0/lib/http/client.rb#111
  def build_response(req, options); end

  # source://http/5.2.0/lib/http/client.rb#192
  def make_form_data(form); end

  # source://http/5.2.0/lib/http/client.rb#177
  def make_request_body(opts, headers); end

  # source://http/5.2.0/lib/http/client.rb#160
  def make_request_headers(opts); end

  # source://http/5.2.0/lib/http/client.rb#142
  def make_request_uri(uri, opts); end

  # source://http/5.2.0/lib/http/client.rb#124
  def verify_connection!(uri); end

  # source://http/5.2.0/lib/http/client.rb#105
  def wrap_request(req, opts); end
end

# source://webmock//lib/webmock/http_lib_adapters/http_rb/request.rb#4
class HTTP::Request
  # source://http/5.2.0/lib/http/request.rb#89
  def initialize(opts); end

  # source://http/5.2.0/lib/http/request.rb#80
  def body; end

  # source://http/5.2.0/lib/http/request.rb#167
  ...
  # source://http/5.2.0/lib/http/request.rb#151
  def include_proxy_headers; end

  # source://http/5.2.0/lib/http/request.rb#220
  def inspect; end

  # source://http/5.2.0/lib/http/request.rb#80
  def proxy; end

  # source://http/5.2.0/lib/http/request.rb#161
  def proxy_authorization_header; end

  # source://http/5.2.0/lib/http/request.rb#186
  def proxy_connect_header; end

  # source://http/5.2.0/lib/http/request.rb#191
  def proxy_connect_headers; end

  # source://http/5.2.0/lib/http/request.rb#106
  def redirect(uri, verb = T.unsafe(nil)); end

  # source://http/5.2.0/lib/http/request.rb#73
  def scheme; end

  # source://http/5.2.0/lib/http/request.rb#203
  def socket_host; end

  # source://http/5.2.0/lib/http/request.rb#208
  def socket_port; end

  # source://http/5.2.0/lib/http/request.rb#136
  def stream(socket); end

  # source://http/5.2.0/lib/http/request.rb#79
  def uri; end

  # source://http/5.2.0/lib/http/request.rb#75
  def uri_normalizer; end

  # source://http/5.2.0/lib/http/request.rb#147
  def using_authenticated_proxy?; end

  # source://http/5.2.0/lib/http/request.rb#142
  def using_proxy?; end

  # source://http/5.2.0/lib/http/request.rb#70
  def verb; end
  ...
  # source://http/5.2.0/lib/http/request.rb#237
  def default_host_header_value; end

  # source://http/5.2.0/lib/http/request.rb#232
  def port; end

  # source://http/5.2.0/lib/http/request.rb#245
  def prepare_body(body); end

  # source://http/5.2.0/lib/http/request.rb#249
  def prepare_headers(headers); end
end

# source://webmock//lib/webmock/http_lib_adapters/http_rb/response.rb#4
class HTTP::Response
  # source://http/5.2.0/lib/http/response.rb#45
  def initialize(opts); end
  ...
  # source://http/5.2.0/lib/http/response.rb#126
  def content_type; end

  # source://http/5.2.0/lib/http/response.rb#140
  def cookies; end

  # source://http/5.2.0/lib/http/response.rb#97
  def flush; end
  ...
  # source://http/5.2.0/lib/http/response.rb#20
  def status; end
  ...
  # source://http/5.2.0/lib/http/response.rb#171
  def default_encoding; end

  # source://http/5.2.0/lib/http/response.rb#180
