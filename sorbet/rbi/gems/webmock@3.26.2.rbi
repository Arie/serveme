...
# pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/request.rb:4
class HTTP::Request
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/request.rb:5
  def webmock_signature; end
end

# pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/response.rb:4
class HTTP::Response
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/response.rb:5
  def to_webmock; end

  private

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/response.rb:91
  def reset_body_to_allow_it_to_be_streamed!(webmock_response); end

  class << self
    # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/response.rb:66
    def build_http_rb_response_body_from_webmock_response(webmock_response); end

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/response.rb:26
    def from_webmock(request, webmock_response, request_signature = T.unsafe(nil)); end

    # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/response.rb:79
...
class HTTP::Response::Streamer
  ...
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/streamer.rb:11
  def readpartial(size = T.unsafe(nil), outbuf = T.unsafe(nil)); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/streamer.rb:39
  def sequence_id; end
end
...
class HTTP::WebMockPerform
  ...
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:12
  def exec; end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:16
  def request_signature; end

  protected

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:65
  def halt; end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:69
  ...
  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:31
  def register_request(signature); end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:35
  def replay; end

  # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb/webmock.rb:27
...
# pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb_adapter.rb:14
class WebMock::HttpLibAdapters::HttpRbAdapter < ::WebMock::HttpLibAdapter
  class << self
    # pkg:gem/webmock#lib/webmock/http_lib_adapters/http_rb_adapter.rb:22
    def disable!; end
