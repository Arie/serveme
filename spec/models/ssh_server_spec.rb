...
describe SshServer do
  ...
  describe '#remove_configuration' do
    ...
    it 'deletes the reservation configs' do
      ...
      subject.should_receive(:execute).with("rm -f /tmp/foo/csgo/cfg/reservation.cfg /tmp/foo/csgo/cfg/mapconfig/maps/training1.cfg /tmp/foo/csgo/cfg/banned_user.cfg /tmp/foo/csgo/cfg/banned_ip.cfg")
